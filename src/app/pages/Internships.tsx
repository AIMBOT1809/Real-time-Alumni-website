...
<<<<<<< Updated upstream
                  <div className="mt-4"><p className="text-sm font-semibold text-yellow-700">{internship.post_details?.companyName}</p><h3 className="mt-1 text-xl font-bold text-slate-950">{internship.post_details?.internshipRole}</h3></div>
                  <dl className="mt-5 space-y-3 text-sm">
                    <div className="flex items-center justify-between gap-3"><dt className="flex items-center gap-2 text-slate-500"><Clock3 className="h-4 w-4" />Duration</dt><dd className="font-semibold text-slate-900">{internship.post_details?.duration}</dd></div>
                    <div className="flex items-center justify-between gap-3"><dt className="flex items-center gap-2 text-slate-500"><IndianRupee className="h-4 w-4" />Stipend</dt><dd className="font-semibold text-slate-900">{internship.post_details?.stipend}</dd></div>
                    <div className="flex items-center justify-between gap-3"><dt className="flex items-center gap-2 text-slate-500"><Laptop2 className="h-4 w-4" />Work mode</dt><dd className="font-semibold text-slate-900">{internship.post_details?.locationType}</dd></div>
                    <div className="pt-1"><dt className="font-medium text-slate-500">Required skills</dt><dd className="mt-2 flex flex-wrap gap-2">{(internship.post_details?.requiredSkills?.split(",") || []).map((skill: string) =>  <span key={skill} className="rounded-lg bg-slate-100 px-2.5 py-1 text-xs font-medium text-slate-700">{skill}</span>)}</dd></div>
